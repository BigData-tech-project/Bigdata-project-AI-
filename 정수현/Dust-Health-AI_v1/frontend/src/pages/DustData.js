...
const DustData = () => {
    ...
    const createEmojiCanvas = (emoji) => {
        ...
        canvas.width = 20; // 캔버스 크기 (작게 조정)
        canvas.height = 20;
        ctx.font = '18px Arial'; // 폰트 크기 줄이기
        ctx.textAlign = 'center';
        ctx.textBaseline = 'middle';
        ctx.fillText(emoji, canvas.width / 2, canvas.height / 2); // 캔버스 중앙에 이모지 그리기
        return canvas;
    };
        ...
        datasets: [
            {
                ...
                pointStyle: pointStyles, // 커스텀 캔버스 포인트 스타일
                pointBorderWidth: 2,
            ...
            <div className='dustdata-grid'>
                ...
                <div className='current-section'>
                        <div className="section current-data-section">
                            ...
                            <Link to='/usernowdata' state={{region, todayDust}}>
