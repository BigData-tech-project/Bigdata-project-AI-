...
const DustData = () => {
    ...
    useEffect(() => {
        if (city && region) {
            ...
            // AI Response 가져오기 
            fetch('http://127.0.0.1:8000/analyze/complex/'+pmValue+'&'+userData,{
                method:'GET'
                }
                )
                .then(res=>res.json())
              ...
              console.log('미세먼지 수치:'+ pmValue);
              console.log('보유 질병: '+ userData);
        }
